 ...
 * matome 記事（特に MLB の試合まとめ / 海外ファンと見る）に、その日の打席結果や今季の節目を
...
const RIVAL_NAMES = {
  ...
  700250: 'ベン・ライス', // Ben Rice (AL)
  678246: 'ミゲル・バルガス', // M.Vargas (AL・White Sox。村上の同僚で日本人ファンが注目)
  // ドジャースのスター野手（大谷の同僚）。一覧「今季のスター野手」で横並び比較する。
  605141: 'ムーキー・ベッツ', // Betts
  518692: 'フレディ・フリーマン', // Freeman
  681624: 'アンディ・パヘス', // Pages
  669242: 'トミー・エドマン', // Edman
  687221: 'ダルトン・ラッシング', // Rushing
  669257: 'ウィル・スミス', // W.Smith
