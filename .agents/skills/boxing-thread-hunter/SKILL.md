---
name: boxing-thread-hunter
description: r/Boxing から日本人読者に刺さりそうな人気スレを探し、候補を採点・選定して、上位コメントを抜粋翻訳し data/threads/boxing/{id}.json を作成する。井上尚弥、中谷潤人、寺地拳四朗、那須川天心、日本人王者、P4P、タイトル戦、階級統一、歴代比較、海外ファンの賛否が割れるボクシング海外反応記事を自動化するときに使う。
---

# ボクシング スレ探索・記事化スキル

`r/Boxing` の人気スレから、日本人読者に受けやすいものを選び、`matome` ルールで
`data/threads/boxing/{id}.json` を作る。

## 使う場面

- 「ボクシングで日本人受けするスレを探して記事にして」
- 「r/Boxing から候補を選んでまとめて」
- 井上尚弥、中谷潤人、寺地拳四朗、那須川天心、日本人王者の海外反応を探す
- P4P、タイトル戦、階級統一、KO、判定、契約、歴代比較で記事候補を選ぶ
...
```sh
node scripts/fetch-reddit.mjs list r/Boxing week 20
...
- 公開済み: `https://mlb-data-matome.vercel.app/`
  - トップページ、ボクシング一覧、必要ならサイト内の個別記事を確認する。
  - 同じ Reddit `sourceUrl`、同じ話題、同じ選手・試合・発言・記録の焼き直しは避ける。
- 公開待ち: `data/threads/boxing/*.json`
...
- 日本人選手:
  - 井上尚弥 / Naoya Inoue / Inoue
  - 中谷潤人 / Junto Nakatani / Nakatani
  - 寺地拳四朗 / Kenshiro Teraji / Teraji
  - 那須川天心 / Tenshin Nasukawa / Tenshin
  - 田中恒成、井岡一翔、武居由樹、堤聖也など日本人王者・有力選手
- 日本で関心が強い選手・テーマ:
  - Oleksandr Usyk、Canelo Alvarez、Terence Crawford、Gervonta Davis
  - Tyson Fury、Anthony Joshua、Deontay Wilder、Ryan Garcia
  - 軽量級、P4P、階級統一、無敗、KO率、世界戦
- 話題:
  - P4P、タイトル戦、統一戦、階級上げ・階級下げ
  - KO、ダウン、判定議論、採点、レフェリー、ドーピング
  - 歴代比較、GOAT 論争、契約金、PPV、興行、引退
...
1. `r/Boxing` の `week` 上位 20 件を取得する。
2. `https://mlb-data-matome.vercel.app/` と `data/threads/boxing/*.json` を見て、公開済み・公開待ち記事と被る候補を除外する。
