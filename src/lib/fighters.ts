...
export const FIGHTERS: Fighter[] = [
  ...
  /* ---------------------------------------------------------------- UFC のグローバルスター
   * 2026-08-24 追加。記事タグの実数で「記事はあるのにLPが無い」取りこぼしが判明したため
   * （ホロウェイ6本・マハチェフ6本・ゲイリー5本・ペレイラ4本＝当時の登録21人中15人より多い）。
   * MLBが止まる11〜2月もUFCは通年で試合があるので、オフシーズンの流入の受け皿にもなる。
   * 戦績・会場は英語版 Wikipedia の MMA戦績表（2026-08-24 参照）で裏取りした実測値のみ。
   * 日本語表記は当サイトの記事タグに合わせ、Wikipedia日本語版の別表記は shortJa で拾う
   * （例: マハチェフ＝ja「イスラム・マカチェフ」／ゲイリー＝ja「イアン・ギャリー」）。
   * ------------------------------------------------------------------------------------- */
  {
    ...
    sport: 'mma',
    voiceScope: 'global',
    accoladeJa: 'UFCウェルター級王者・元ライト級王者。UFC歴代最長の17連勝（2026年8月時点）',
    record: { wins: 29, losses: 1, draws: 0, kos: 5, asOf: '2026-08-15' },
    headlineStats: [
      { value: '17連勝', labelJa: 'UFC歴代最長の連勝記録（2026年8月15日・UFC 330 時点）' },
      { value: '2階級', labelJa: 'ライト級・ウェルター級の2階級で王座' },
    ],
    sameAs: [
      'https://ja.wikipedia.org/wiki/%E3%82%A4%E3%82%B9%E3%83%A9%E3%83%A0%E3%83%BB%E3%83%9E%E3%82%AB%E3%83%81%E3%82%A7%E3%83%95',
      'https://en.wikipedia.org/wiki/Islam_Makhachev',
    ],
    fights: [
      {
        date: '2026-08-15',
        opponentJa: 'イアン・マチャド・ゲイリー',
        opponentEn: 'Ian Machado Garry',
        venueJa: 'フィラデルフィア（UFC 330）',
        resultJa: '3-0判定勝ち（5R）',
        noteJa: 'ウェルター級王座初防衛。この勝利でUFC17連勝＝歴代最長の連勝記録を更新した',
      },
      {
        date: '2025-11-15',
        opponentJa: 'ジャック・デラ・マダレナ',
        opponentEn: 'Jack Della Maddalena',
        venueJa: 'ニューヨーク（Madison Square Garden・UFC 322）',
        resultJa: '3-0判定勝ち（5R）',
        noteJa: 'ウェルター級王座を奪取＝2階級制覇',
      },
      {
        date: '2025-01-18',
        opponentJa: 'ヘナト・モイカノ',
        opponentEn: 'Renato Moicano',
        venueJa: 'イングルウッド（Intuit Dome・UFC 311）',
        resultJa: '1回一本勝ち（ブラボーチョーク・4分5秒）',
        noteJa: 'ライト級王座防衛',
      },
      {
        date: '2024-06-01',
        ...
        opponentEn: 'Dustin Poirier',
        tag: 'ダスティン・ポワリエ',
        venueJa: 'ニューアーク（Prudential Center・UFC 302）',
        resultJa: '5回一本勝ち（ブラボーチョーク・2分42秒）',
        noteJa: 'ライト級王座防衛',
      },
      {
        date: '2023-10-21',
        opponentJa: 'アレクサンダー・ボルカノフスキー',
        opponentEn: 'Alexander Volkanovski',
        venueJa: 'アブダビ（Etihad Arena・UFC 294）',
        resultJa: '1回KO勝ち（ハイキック・3分6秒）',
        noteJa: 'ライト級王座防衛',
      },
    ],
  },
  {
    ...
    sport: 'mma',
    voiceScope: 'global',
    accoladeJa: '元UFCフェザー級王者・元BMF王者',
    record: { wins: 28, losses: 9, draws: 0, kos: 13, asOf: '2026-07-11' },
    sameAs: [
      'https://ja.wikipedia.org/wiki/%E3%83%9E%E3%83%83%E3%82%AF%E3%82%B9%E3%83%BB%E3%83%9B%E3%83%AD%E3%82%A6%E3%82%A7%E3%82%A4',
      'https://en.wikipedia.org/wiki/Max_Holloway',
    ],
    fights: [
      {
        date: '2026-07-11',
        opponentJa: 'コナー・マクレガー',
        opponentEn: 'Conor McGregor',
        venueJa: 'ラスベガス（T-Mobile Arena・UFC 329）',
        resultJa: '1回TKO勝ち（相手の膝負傷・1分9秒）',
        noteJa: 'マクレガーの5年ぶり復帰戦。開始1分9秒で相手が右膝を負傷し続行不能に',
      },
      {
        date: '2026-03-07',
        opponentJa: 'チャールズ・オリベイラ',
        opponentEn: 'Charles Oliveira',
        venueJa: 'ラスベガス（UFC 326）',
        resultJa: '0-3判定負け（5R）',
        noteJa: 'BMF王座を失う',
      },
      {
        ...
        opponentEn: 'Dustin Poirier',
        tag: 'ダスティン・ポワリエ',
        venueJa: 'ニューオーリンズ（UFC 318）',
        resultJa: '3-0判定勝ち（5R）',
        noteJa: 'BMF王座防衛。ポイリエの引退試合',
      },
      {
        date: '2024-10-26',
        opponentJa: 'イリア・トプリア',
        opponentEn: 'Ilia Topuria',
        venueJa: 'アブダビ（UFC 308）',
        resultJa: '3回KO負け（パンチ・1分34秒）',
        noteJa: 'フェザー級王座挑戦',
      },
      {
        date: '2024-04-13',
        opponentJa: 'ジャスティン・ゲイジー',
        opponentEn: 'Justin Gaethje',
        venueJa: 'ラスベガス（UFC 300）',
        resultJa: '5回KO勝ち（パンチ・4分59秒）',
        noteJa: 'BMF王座を獲得。残り1秒で打ち合いに応じてのKO',
      },
    ],
  },
  {
    slug: 'ian-machado-garry',
    nameJa: 'イアン・マチャド・ゲイリー',
    nameEn: 'Ian Machado Garry',
    shortJa: ['ゲイリー', 'ギャリー', 'ガリー'],
    sport: 'mma',
    voiceScope: 'global',
    accoladeJa: 'UFCウェルター級コンテンダー（2026年8月に王座挑戦）。アイルランド出身',
    record: { wins: 17, losses: 2, draws: 0, kos: 7, asOf: '2026-08-15' },
    sameAs: [
      'https://ja.wikipedia.org/wiki/%E3%82%A4%E3%82%A2%E3%83%B3%E3%83%BB%E3%82%AE%E3%83%A3%E3%83%AA%E3%83%BC',
      'https://en.wikipedia.org/wiki/Ian_Machado_Garry',
    ],
    fights: [
      {
        date: '2026-08-15',
        opponentJa: 'イスラム・マハチェフ',
        opponentEn: 'Islam Makhachev',
        venueJa: 'フィラデルフィア（UFC 330）',
        resultJa: '0-3判定負け（5R）',
        noteJa: 'ウェルター級王座挑戦',
      },
      {
        date: '2025-11-22',
        opponentJa: 'ベラル・ムハマド',
        opponentEn: 'Belal Muhammad',
        venueJa: 'アル・ライヤーン（UFC Fight Night 265）',
        resultJa: '3-0判定勝ち（3R）',
      },
      {
        date: '2025-04-26',
        opponentJa: 'カルロス・プラテス',
        opponentEn: 'Carlos Prates',
        venueJa: 'カンザスシティ（UFC on ESPN 66）',
        resultJa: '3-0判定勝ち（5R）',
      },
      {
        date: '2024-12-07',
        opponentJa: 'シャフカト・ラフモノフ',
        opponentEn: 'Shavkat Rakhmonov',
        venueJa: 'ラスベガス（UFC 310）',
        resultJa: '0-3判定負け（5R）',
        noteJa: '王座挑戦者決定戦',
      },
      {
        date: '2024-06-29',
        opponentJa: 'マイケル・ペイジ',
        opponentEn: 'Michael Page',
        venueJa: 'ラスベガス（UFC 303）',
        resultJa: '3-0判定勝ち（3R）',
      },
    ],
  },
  {
    ...
    sport: 'mma',
    voiceScope: 'global',
    accoladeJa: '元UFCライトヘビー級王者（2度戴冠）・元GLORY 2階級王者。2026年からヘビー級',
    record: { wins: 13, losses: 4, draws: 0, kos: 11, asOf: '2026-06-14' },
    headlineStats: [
      { value: '11/13', labelJa: 'KO/TKO決着の勝利（通算13勝中）' },
    ],
    sameAs: [
      'https://ja.wikipedia.org/wiki/%E3%82%A2%E3%83%AC%E3%83%83%E3%82%AF%E3%82%B9%E3%83%BB%E3%83%9A%E3%83%AC%E3%82%A4%E3%83%A9',
    ...
    fights: [
      {
        date: '2026-06-14',
        opponentJa: 'シリル・ガーヌ',
        opponentEn: 'Ciryl Gane',
        venueJa: 'ワシントンD.C.（UFC Freedom 250・ホワイトハウス大会）',
        resultJa: '2回TKO負け（パンチ・1分27秒）',
        noteJa: 'ヘビー級デビュー戦で暫定王座に挑戦',
      },
      {
        date: '2025-10-04',
        opponentJa: 'マゴメド・アンカラエフ',
        opponentEn: 'Magomed Ankalaev',
        venueJa: 'ラスベガス（UFC 320）',
        resultJa: '1回TKO勝ち（パンチと肘・1分20秒）',
        noteJa: 'ライトヘビー級王座を奪回＝2度目の戴冠',
      },
      {
        date: '2025-03-08',
        opponentJa: 'マゴメド・アンカラエフ',
        opponentEn: 'Magomed Ankalaev',
        venueJa: 'ラスベガス（UFC 313）',
        resultJa: '0-3判定負け（5R）',
        noteJa: 'ライトヘビー級王座を失う',
      },
      {
        date: '2024-10-05',
        opponentJa: 'カリル・ラウントリーJr.',
        opponentEn: 'Khalil Rountree Jr.',
        venueJa: 'ソルトレイクシティ（UFC 307）',
        resultJa: '4回TKO勝ち（パンチ・4分32秒）',
        noteJa: 'ライトヘビー級王座防衛',
      },
      {
        date: '2024-06-29',
        opponentJa: 'イリー・プロハースカ',
        opponentEn: 'Jiří Procházka',
        venueJa: 'ラスベガス（UFC 303）',
        resultJa: '2回TKO勝ち（ハイキックとパンチ・13秒）',
        noteJa: 'ライトヘビー級王座防衛',
      },
    ],
  },
