...
export const RIZIN5 = {
  ...
  tickets: {
    ...
    noteJa:
      '選手ごとの「復活応援シートS席」（各36,300円）は、8月18日に6種すべてが完売した（朝倉未来・平本蓮・斎藤裕・YA-MAN・RENA、そしてシェイドゥラエフの「全力応援シート」）。通常席もS席・A席・SRS席・VVIP1列席が完売していて、いま買えるのはVVIP2・3列席とVIP席とRS席、それに18日10時から追加で開いた外野S席（31,900円）と外野A席（15,400円）で、この状況は8月23日時点で変わっていない。外野席は選手の入場が一部見えない場合があると公式が明記している。残席状況は日々変わるので、購入前に公式ページで最新の販売状況を確認してほしい。',
    links: [
