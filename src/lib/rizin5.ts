...
export const RIZIN5 = {
  ...
  viewing: {
    ...
    announced: false,
    noteJa:
      '超RIZIN.5の配信・PPVの公式発表はまだ出ていない（2026年8月12日時点で再確認。公式サイトも「決定次第案内」の表記）。これまでのRIZINの大型大会はABEMA・U-NEXT・スカパー!・RIZIN LIVEなどでPPV販売されてきたので、当たりを付けるための直近実績を下に置いておく。発表が出たら、この欄を価格・購入手順つきで即日更新する。',
    /**
