...
export const RIZIN5 = {
  ...
  videos: [
    {
      url: 'https://www.youtube.com/watch?v=RN4RoB5rpog',
      titleJa: '【Trailer】超RIZIN.5 浪速の超復活祭り（対戦カード版・2026.8.13）',
      date: '2026-08-13',
      noteJa: 'シェイドゥラエフvsAJ・マッキー、朝倉未来vs青木真也を前に出した最新のトレーラー。いまの大会の顔はこの映像。',
    },
    {
      url: 'https://www.youtube.com/watch?v=28udJ9a28MI',
      titleJa: '【朝倉未来×シェイドゥラエフ】くるみの超RIZIN.5記者会見裏側リポート（2026.8.26）',
      date: '2026-08-26',
      noteJa: 'カード発表会見の舞台裏。復帰する朝倉未来と、去年の大晦日にその朝倉を壊した無敗の王者が同じ画面に映る。',
    },
    {
      url: 'https://www.youtube.com/watch?v=Zgo-nVipTEo',
      titleJa: '超緊急追加カード発表&国民超予想SP（2026.8.17）',
      date: '2026-08-17',
      noteJa: '9試合目の宇佐美秀メイソンvsベイノアが決まった番組。ベイノアがMMAルールを逆提案し、その場でOFGルールに落ち着く一部始終が見られる。',
    },
    {
      url: 'https://www.youtube.com/watch?v=1rYyBfh0kXg',
      titleJa: '【Trailer】超RIZIN.5 浪速の超復活祭り（2026.7.10）',
      date: '2026-07-10',
      noteJa: '大阪城から始まる第1弾トレーラー。大会のキービジュアルはこの映像から。',
    },
    {
  ...
  viewing: {
    ...
    announced: true,
    noteJa:
      '値段が出た。視聴チケットは8月17日（月）12時からRIZIN 100 CLUB・RIZIN LIVE・ABEMAの3つで発売中で、スカパー!は8月27日（木）から。ABEMAがRIZINの公式メディアパートナーになったので単独販売かと思っていたら、公式のPPV情報ページは4つの販路を並べていた。標準の値段は前売6,500円・当日6,900円・アーカイブ5,000円（スカパー!のみ6,900円で価格体系が別）。ここに割引が2種類乗る。ひとつはRIZIN 100 CLUBの会員特別価格で1,000円引き。もうひとつがABEMA限定の「超早割引チケット」で、8月23日23時59分までブラウザ購入6,000円（アプリは6,600円）＝24日からは前売り6,500円に上がる。さらにABEMAプレミアムに新規登録して条件を満たすと3,500円のキャッシュバックがあり、超早割をブラウザで買えば実質2,500円。前売り価格で買えるのは前日9月9日の23時59分まで。配信は9月10日15時開始予定（ABEMAは16時開始・15時から配信ページ）、アーカイブは9月15日まで。⚠️ライブ配信の追っかけ再生は原則できず（一部対応）、アーカイブは権利の都合で一部楽曲がミュートされる。',
  ...
  tickets: {
    ...
    noteJa:
      '選手ごとの「復活応援シートS席」（各36,300円）は、8月18日に6種すべてが完売した（朝倉未来・平本蓮・斎藤裕・YA-MAN・RENA、そしてシェイドゥラエフの「全力応援シート」）。通常席もS席・A席・SRS席・VVIP1列席が完売していて、いま買えるのはVVIP2・3列席とVIP席とRS席、それに18日10時から追加で開いた外野S席（31,900円）と外野A席（15,400円）で、この状況は8月27日時点でも変わっていない。外野席は選手の入場が一部見えない場合があると公式が明記している。残席状況は日々変わるので、購入前に公式ページで最新の販売状況を確認してほしい。',
    links: [
  ...
  road: [
    {
      ...
      body: [
        '合同公開練習が決まった。8月29日の土曜、16時半から都内某所で、終わりは18時ごろの予定。登壇予定が10人で、朝倉未来、青木真也、平本蓮、ホベルト・サトシ・ソウザ、野村駿太、YA-MAN、高木凌、冨澤大智、ベイノア、宇佐美秀メイソン。会場に入れるのはファンクラブ「強者ノ巣」の会員だけだけど、RIZIN公式YouTubeでライブ配信される。9月10日までにこの面子が一度に喋る場は、たぶんここと前日会見しかない。',
        'メインの2人、シェイドゥラエフとAJ・マッキーの名前が登壇予定に無いのが少し気になる。海外組だから来日の日程次第だとは思う。',
        'そして大阪では、もう地上戦が始まっていた。28日の金曜から関西グルメジャックというのが動く。大衆酒場どんがめの21店舗を軸に、大阪・兵庫・京都の飲食店およそ100店でポスターを貼り、応援メニューを頼むとうちわがもらえて、直筆サイン色紙が当たるキャンペーンまでやる。居酒屋100軒に大会ポスターが貼られる興行、というのは字面だけで強い。',
        'さらに9月5日と6日には、大阪北港マリーナで格闘TvRの公開収録を兼ねたファンイベント。17時半から2時間、参加8,000円でビュッフェと飲み放題つき、ゲストファイターは日替わり。応募の締切が8月30日なので、行くなら今週中に決める必要がある。',
        '配信の話をひとつ。スカパー!のPPVが今日27日から売り出す。これで4販路すべてが店を開けたことになる。前売り価格で買えるのは9月9日の23時59分まで。',
      ],
      link: {
        href: 'https://jp.rizinff.com/_ct/17859429',
        labelJa: '合同公開練習の詳細（RIZIN公式・8/29 16:30〜・公式YouTubeでライブ配信）',
      },
    },
    {
      date: '2026-08-23',
      titleJa: '超早割は今夜まで。トレーラーも差し替わった',
      body: [
        'ABEMAの超早割引チケットが今日8月23日の23時59分で終わる。ブラウザ購入6,000円で買えるのはここまでで、明日24日からは前売り6,500円。ABEMAプレミアムの新規登録とキャンペーン条件を満たせば3,500円が返ってくる建て付けは変わらないので、その組み合わせがいちばん安く済むのも今日まで、ということになる。',
        '公式の映像も動いていた。8月13日に新しいトレーラーが出ていて、こっちはシェイドゥラエフvsAJ・マッキーと朝倉未来vs青木真也を題字に入れた対戦カード版。7月の第1弾が大阪城から始まる大会告知だったのに対して、今度は完全に試合を売りにきている。上の公式映像の欄を、この最新版を先頭にして並べ替えた。',
        '17日の追加カード発表SPも公式チャンネルにアーカイブが上がっていた。31万回再生、コメント792件。ベイノアがMMAルールを逆提案して、その場でOFGルールに落ち着く一部始終はここで見られる。',
        'それから22日、ABEMAで「ボクらのRIZIN 青木真也編」の無料配信が始まった。RIZIN公式チャンネルには5分の切り出しが上がっている。11年ぶりに帰ってきた43歳が何を喋るのかは、9月10日の見え方をたぶん変える。',
        'チケットの残りは18日から動いていない。買えるのはVVIP2・3列とVIPとRS、それに外野SとA。あと2週間半。',
      ],
      link: {
        href: 'https://www.youtube.com/watch?v=RN4RoB5rpog',
        labelJa: '最新トレーラー（RIZIN公式・2026.8.13）',
      },
    },
    {
      date: '2026-08-18',
