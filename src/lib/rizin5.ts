...
export const RIZIN5 = {
  ...
  viewing: {
    ...
    announced: true,
    noteJa:
      '値段が出た。超RIZIN.5はABEMA PPVの単独販売で、視聴チケットは8月17日（月）12時に発売済み。いちばん安いのは8月23日23時59分までの「超早割引チケット」でブラウザ購入6,000円（アプリ内購入は6,600円）。24日から前売り6,500円、当日9月10日は6,900円と、遅くなるほど上がる階段式で、見逃し用のアーカイブチケット（5,000円）は9月11日から。買う場所で値段が違うので、ブラウザ（クレジット決済のみ）から買うほうが安い。そして今回いちばん効くのがキャッシュバック。ABEMAプレミアムに新規登録のうえ対象チケットを買い、キャンペーン条件を満たすと3,500円が返ってくる＝超早割をブラウザで買えば実質2,500円で全8試合。配信は9月10日16時開始（15時から配信ページが開く）、見逃し配信は9月15日23時59分まで。',
    /** ABEMA PPV の確定情報（2026-08-17 ABEMA 公式リリース＝PR TIMES 000003803.000064643 の転記） */
    ppv: {
      platformJa: 'ABEMA PPV（単独販売・全8試合生中継）',
    ...
    pastPpvNoteJa:
      '価格はいずれも各大会当時の販売価格（税込）。超RIZIN.5の前売り6,500円・当日6,900円は超RIZIN.4と同額で、超早割の6,000円ぶんだけ早く買った人が得をする設計。⚠️U-NEXT・スカパー!・RIZIN LIVEは過去大会での販路であり、超RIZIN.5はABEMA PPVのみ。',
  },
  ...
  tickets: {
    ...
    noteJa:
      'S席は8月6日に追加販売が出たが再び完売し、8月17日時点で55,000円のSRS席も完売した。選手ごとの「復活応援シートS席」（各36,300円）は朝倉未来・平本蓮・斎藤裕・YA-MANの4人ぶんが完売、残っているのはRENAとシェイドゥラエフ（全力応援シート）だけ。残席状況は日々変わるので、購入前に公式ページで最新の販売状況を確認してほしい。',
    links: [
  ...
  road: [
    {
      ...
      body: [
        '予告どおり8月17日の正午にABEMAがPPVチケットの販売を始めた。値段はブラウザ購入で超早割6,000円、アプリ内購入で6,600円。この値段で買えるのは23日の23時59分まで。24日からは前売り6,500円、当日の10日は6,900円。去年の超RIZIN.4が前売6,500円・当日6,900円だったから、据え置きの値段に「1週間以内に決めた人だけ500円引き」を足した形。',
        'で、今回いちばん効くのがキャッシュバック。ABEMAプレミアムに新規で登録して対象チケットを買い、条件を満たすと3,500円が返ってくる。超早割をブラウザで買えば実質2,500円で全8試合。プレミアムの月額はかかるので誰にとっても得とは言わないけど、どうせ見逃し配信も過去大会も見る人にはこれが正解筋だと思う。細かい条件は買う前にABEMAの案内を読んでほしい。',
        ...
        '追加カードは今夜18時、格闘チャンネルの特番待ち。青木と平本が出る。出たらこのページの対戦カード表に足す。',
      ],
      link: {
    ...
    },
    {
      ...
      body: [
        'ABEMAがRIZINの公式メディアパートナーになった。超RIZIN.5からの連携で、全8試合がABEMA PPVで生中継される。榊原CEOの言い方が印象的で、9月からABEMAさんだけでPPVを配信、と。これまでの大会はABEMAとU-NEXTとスカパー!とRIZIN LIVEが横並びで売っていたので、買う場所を選ぶ時代がここで終わるっぽい。',
