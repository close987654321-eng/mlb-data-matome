...
export const RIZIN5 = {
   ...
   */
  tickets: {
    statusJa: '一般発売中（2026年7月12日 10:00〜）。スマートフォン対応の電子チケット。8月18日（火）10:00からは「外野S席」「外野A席」の追加販売が始まる。',
    asOfJa: '2026年8月17日',
    seats: [
      ...
      // 2026-08-18 10:00 追加販売（公式ニュース jp.rizinff.com/_ct/17858309）。発売前なので soldOut は持たない。
      { nameJa: '外野S席（8/18 10:00〜追加販売）', price: 31_900 },
      { nameJa: '外野A席（8/18 10:00〜追加販売）', price: 15_400 },
    ] satisfies Rizin5Seat[],
    noteJa:
      'S席は8月6日に追加販売が出たが再び完売し、8月17日時点で55,000円のSRS席も完売した。選手ごとの「復活応援シートS席」（各36,300円）は朝倉未来・平本蓮・斎藤裕・YA-MANの4人ぶんが完売、残っているのはRENAとシェイドゥラエフ（全力応援シート）だけ。そして8月17日、大好評につきという枕詞つきで「外野S席」31,900円と「外野A席」15,400円の追加販売が決まった（8月18日10:00から）。外野S席は選手の入場が一部見えない場合があると公式が明記している。残席状況は日々変わるので、購入前に公式ページで最新の販売状況を確認してほしい。',
    links: [
